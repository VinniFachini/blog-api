<template>
  <div class="sidebar-container">
    <div class="top-section">
      ...
      <div class="links">
        ...
        <NuxtLink
          to="/admin/posts"
          activeClass="active"
          :class="{ active: isActiveRoute('/admin/posts') }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <NuxtLink
          ...
          :class="{ active: isActiveRoute('/admin/comments') }"
        >
          ...
          <span v-if="commentsCounter > 0" class="commentsCounter">{{ commentsCounter }}</span>
        </NuxtLink>
        <NuxtLink
          to="/admin/categories"
          activeClass="active"
    ...
    <div class="footer">
      <button
        @click="logoutUser"
        class="logout text-gray-600 fill-current hover:text-red-500"
      >
        <svg
          class="w-5 h-5"
          viewBox="0 0 24 24"
...
export default {
  ...
  async mounted() {
    ...
    let length = await response.length
    this.commentsCounter = length
    console.log(this.commentsCounter)
  }
};
</script>